                    ...
                    <tbody>
                      <tr> 
                       <td rowspan="2" style="width:115px;padding:20px 20px 0 0;vertical-align:top;font-size:13px;line-height:18px;font-family:Arial,sans-serif"> <a href="" title="" style="text-decoration:none;color:rgb(0,102,153);font:12px/16px Arial,sans-serif" target="_blank">
                        <img alt="" src="<?=$vars['store_details']['s_img'];?>"> </a> </td> 
                      ...
                      <tr> 
                       <td colspan="3" style="text-align:right;padding:7px 0 5px 0;vertical-align:top;font-size:13px;line-height:18px;font-family:Arial,sans-serif"> <h2 style="font-size:20px;line-height:24px;margin:0;padding:0;font-weight:normal;color:rgb(0,0,0)!important">Order Confirmation</h2> Order #<a href="" style="text-decoration:none;color:rgb(0,102,153);font:12px/16px Arial,sans-serif" target="_blank" ><?=$vars['order_details']['order_id'];?></a> <br> </td> 
                      </tr> 
                    </tbody>
                  </table>
                </td> 
                    ...
                    <tbody>
                      <tr> 
                        <td style="font-size:14px;padding:11px 18px 18px 18px;background-color:rgb(239,239,239);width:50%;vertical-align:top;line-height:18px;font-family:Arial,sans-serif">
                          <!--<p style="margin:2px 0 9px 0;font:14px Arial,sans-serif"><span style="font-size:14px;color:rgb(102,102,102)">Arriving:</span><br> <b style="color:#009900"><span class="aBn" data-term="goog_2102453370" tabindex="0"><span class="aQJ">Saturday, March 12</span></span></b> </p> <p style="margin:2px 0 9px 0;font:14px Arial,sans-serif"> <span style="font-size:14px;color:rgb(102,102,102)">Your shipping speed:</span> <br> <b> Two-Day Delivery at Rs. 50 </b> </p> <a href="" style="font-size:11px;color:rgb(102,102,102);text-decoration:underline;font:12px/16px Arial,sans-serif" target="_blank" >
                          <img alt="Your Orders" src="" style="border:0" border="0" class="CToWUd"> </a>-->
                        </td> 
                         <td style="font-size:14px;padding:11px 18px 18px 18px;background-color:rgb(239,239,239);width:50%;vertical-align:top;line-height:18px;font-family:Arial,sans-serif"> <p style="margin:2px 0 9px 0;font:14px Arial,sans-serif"> <span style="font-size:14px;color:rgb(102,102,102)">Your order will be sent to:</span> <br> <b> <?=$vars['customer_details']['c_name'];?> <br> <?=$vars['customer_details']['c_address'];?> <br> <?=$vars['customer_details']['c_address2'];?><br> <?=$vars['customer_details']['c_city'];?>, <?=$vars['customer_details']['c_state'];?> <?=$vars['customer_details']['c_zipcode'];?> <br> <?=$vars['customer_details']['c_country'];?> </b> </p>
                        </td> 
                      </tr> 
                    </tbody>
                  </table>
              ...
              <tr> 
                <td style="vertical-align:top;font-size:13px;line-height:18px;font-family:Arial,sans-serif"> 
                  <table style="width:100%;border-collapse:collapse"> 
                    <tbody>
                      <tr> 
                       <td style="vertical-align:top;font-size:13px;line-height:18px;font-family:Arial,sans-serif"> Order #<a href="" style="text-decoration:none;color:rgb(0,102,153);font:12px/16px Arial,sans-serif" target="_blank" ><?=$vars['order_details']['order_id'];?></a> <br> <span style="font-size:12px;color:rgb(102,102,102)">Placed on <?=$vars['order_details']['placed_on'];?></span>
                       </td> 
                      </tr> 
                    </tbody>
                  </table>
                            ...
                            ?>
                              <tr>
                                <td colspan="1" style="width:100px;text-align:left;padding:0 0 30px 0;vertical-align:top;font-size:13px;line-height:18px;font-family:Arial,sans-serif"><a href="" style="text-decoration:none;color:rgb(0,102,153);font-size:13px;line-height:18px;font-family:Arial,sans-serif" target="_blank"></a>
                                  <?php if(!empty($p_value['file_name'])){ 
                                    ?>
                                  <img height="115" src="https://s3.amazonaws.com/inventory-clara/product-images/<?=$p_value['product_id']?>/<?=$p_value['file_name']?>">
                                  <?php } else { ?>
                                  <img height="115" src="https://s3.amazonaws.com/inventory-clara/images/nophoto2.jpg">
                                  <?php } ?>
                                </td>
                                <td colspan="1" style="color:rgb(102,102,102);padding:10px 10px 30px 10px;vertical-align:middle;font-size:13px;line-height:18px;font-family:Arial,sans-serif">
                                  <ul style="margin:0;padding:0">
                                    <li style="list-style-type:none;line-height:14px;padding:0 0 4px 0">
                                      ...
                                      <?=$p_value['product_variant_name'];?></a>
                                    </li>
                                  </ul>
                                </td>
                                <td style="font-family:Arial,sans-serif;text-align:center;"><?=$p_value['ordered_qty'];?></td>
                                <td style="width:110px;text-align:right;font-size:14px;padding:10px 10px 0 0;vertical-align:middle;line-height:18px;font-family:Arial,sans-serif"><strong><?=displayData($p_value['ordered_price'],'money');?></strong></td>
                              </tr>
                            <?php
                          }
                        }
                ...
                <td style="vertical-align:top;font-size:13px;line-height:18px;font-family:Arial,sans-serif"> 
                  <table style="width:95%;border-collapse:collapse"> 
                    <tbody>
                      ...
                      <tr> 
                       <td style="text-align:right;line-height:18px;padding:0 10px 0 0;vertical-align:top;font-size:13px;font-family:Arial,sans-serif"> Item Subtotal: </td> 
                       <td style="width:120px;text-align:right;line-height:18px;padding:0 10px 0 0;vertical-align:top;font-size:13px;font-family:Arial,sans-serif"> <?=displayData($vars['order_details']['sub_total'],'money');?></td> 
                      </tr> 
                      <tr> 
                        <td style="text-align:right;line-height:18px;padding:0 10px 0 0;vertical-align:top;font-size:13px;font-family:Arial,sans-serif"> Shipping &amp; Handling: </td> 
                        <td style="width:120px;text-align:right;line-height:18px;padding:0 10px 0 0;vertical-align:top;font-size:13px;font-family:Arial,sans-serif"> <?=displayData($vars['order_details']['shipping_fee'],'money');?></td> 
                      </tr>
                      <tr> 
                        <td colspan="2" style="text-align:right;line-height:18px;padding:0 10px 0 0;vertical-align:top;font-size:13px;font-family:Arial,sans-serif"> <p style="margin:0 0 8px 0;font:12px/16px Arial,sans-serif"></p> </td> 
                      </tr> 
                      <tr> 
                        <td style="text-align:right;line-height:18px;padding:0 10px 0 0;vertical-align:top;font-size:13px;font-family:Arial,sans-serif"> Discount: </td> 
                        <td style="width:120px;text-align:right;line-height:18px;padding:0 10px 0 0;vertical-align:top;font-size:13px;font-family:Arial,sans-serif"><?=displayData($vars['order_details']['discount'],'money');?></td> 
                      </tr>
                      ...
                      <tr> 
                        <?php
                       if(isset($vars['order_details']['tax']) && ($vars['order_details']['tax']!=''))
                        { 
                        ?>
                        <td style="text-align:right;line-height:18px;padding:0 10px 0 0;vertical-align:top;font-size:13px;font-family:Arial,sans-serif"> Tax: </td> 
                      <?php } ?>
                        <td style="width:120px;text-align:right;line-height:18px;padding:0 10px 0 0;vertical-align:top;font-size:13px;font-family:Arial,sans-serif"><?php if(isset($vars['order_details']['tax']) && ($vars['order_details']['tax']!='')){ echo displayData($vars['order_details']['tax'],'money'); }?></td> 
                      </tr>
                      ...
                      <tr> 
                        <td style="font-size:14px;font-weight:bold;font:12px/16px Arial,sans-serif;text-align:right;line-height:18px;padding:0 10px 0 0;vertical-align:top;font-family:Arial,sans-serif"> <b>Order Total:</b> </td> 
                        <td style="font-size:14px;font-weight:bold;font:12px/16px Arial,sans-serif;text-align:right;line-height:18px;padding:0 10px 0 0;vertical-align:top;font-family:Arial,sans-serif"> <b><?=displayData($vars['order_details']['total'],'money');?></b> </td>
                      </tr>
                      <tr> 
